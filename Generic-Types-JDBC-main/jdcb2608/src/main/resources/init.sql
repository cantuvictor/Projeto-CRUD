-- Create Database
CREATE DATABASE IF NOT EXISTS `jdbc2608`;
USE `jdbc2608`;
...
-- Table: sale_item_type
CREATE TABLE `sale_item_type` (
                                  `id` INT AUTO_INCREMENT PRIMARY KEY,
                                  `description` VARCHAR(255) NOT NULL
);
...
INSERT INTO `sale_type` (`description`) VALUES
                                            ('Type A'),
                                            ('Type B'),
                                            ('Type C');

INSERT INTO `sale_item_type` (`description`) VALUES
                                                 ('Item A'),
                                                 ('Item B'),
                                                 ('Item C');
